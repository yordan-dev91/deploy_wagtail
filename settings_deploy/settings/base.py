...
ROOT_URLCONF = "settings_deploy.urls"
...
WSGI_APPLICATION = "settings_deploy.wsgi.application"


# Database-https://docs.djangoproject.com/en/5.2/ref/settings/#databases
DATABASES = {
    'default': env.db(default='postgresql://local_user:local_password1234@localhost:5440/local_db')
}
...
# Wagtail settings
WAGTAIL_SITE_NAME = "settings_deploy"
